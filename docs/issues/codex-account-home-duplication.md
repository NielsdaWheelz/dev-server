...
the herdr gate also hardcodes them. workstation home projection is repeated
...
`assets/codex/codex-shared.py:210`, `lib/skidbladnir.sh:113`, and
`assets/herdr/herdr-gate:37`.
