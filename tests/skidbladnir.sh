...
test_pin_and_config_contract() (
  ...
  assert_eq v0.2.29 "${line%%$'\t'*}" 'current release version'
  [[ "$line" == *$'\thttps://github.com/NielsdaWheelz/skidbladnir/releases/download/v0.2.29/skidbladnir-linux-amd64.tar.gz\t6837f88867ba730f09bfcf37ae7689c8d1a8cb3e76673845864c4209d295e1c2\tlinux-amd64' ]] ||
    fail 'current Linux URL or digest differs'
  cp "$pin" "$valid"
  sed 's/"version": "v0.2.29"/"version": "v0.2.29", "version": "v0.2.29"/' \
    "$valid" >"$duplicate"
